...
export default class MyMerchDetails extends Component {
  renderlistQR = () => {
    var temp = [
      {
        poster: ""
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              >
                <Text style={UtilStyles.standardText}>Merchandise</Text>
              </View>
              ...
              <View style={{ width: "100%", marginBottom: 10 }}>
                <View style={{ marginHorizontal: 20, flexDirection: "row" }}>
                  ...
                  >
                    <Text style={UtilStyles.standardText}>Type</Text>
                  </Left>
                  <Right
                    style={{
                      flex: 1,
              ...
              <View style={{ width: "100%", marginBottom: 10 }}>
                <View style={{ marginHorizontal: 20, flexDirection: "row" }}>
                  ...
                  >
                    <Text style={UtilStyles.standardText}>Size L</Text>
                  </Right>
                </View>
              </View>
