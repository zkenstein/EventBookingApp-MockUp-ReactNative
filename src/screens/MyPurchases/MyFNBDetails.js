...
export default class MyFNBDetails extends Component {
  renderlistQR = () => {
    var temp = [
      {
        poster: ""
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              >
                <Text style={UtilStyles.standardText}>Food & Beverage</Text>
              </View>
              ...
              <View style={{ width: "100%", marginBottom: 10 }}>
                <View style={{ marginHorizontal: 20, flexDirection: "row" }}>
                  ...
                  >
                    <Text style={UtilStyles.standardText}>Eat</Text>
                  </Left>
                  <Right
                    style={{
                      flex: 1,
                  ...
                  >
                    <Text style={UtilStyles.standardText}>Burger</Text>
                  </Right>
                </View>
              </View>
              ...
              <View style={{ width: "100%", marginBottom: 10 }}>
                <View style={{ marginHorizontal: 20, flexDirection: "row" }}>
                  ...
                  >
                    <Text style={UtilStyles.standardText}>Drink</Text>
                  </Left>
                  <Right
                    style={{
                      flex: 1,
                  ...
                  >
                    <Text style={UtilStyles.standardText}>Coke</Text>
                  </Right>
                </View>
              </View>
