...
import MerchandiseDetailsHeader from "./FoodBeverageDetailsHeader";
import ImageSlider from "react-native-image-slider";
import FoodBeverageDetailsHeader from "./FoodBeverageDetailsHeader";
import { tryFunctionOrLogError } from "apollo-utilities";
import CalendarPicker from "react-native-calendar-picker";

export default class FoodBeverageDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <View style={{ width: "100%", marginBottom: 10 }}>
          ...
          {/* <View style={{ marginHorizontal: 20, flexDirection: "row" }}>
            ...
            >
              ...
              >
                <Text style={UtilStyles.btnTextBlack}>1 December 2019</Text>
                <Icon
                  size={20}
                  style={{
                    color: "black",
